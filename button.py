...
class Button:
    ...
    def draw(self, display, Border=False, BorderColor=BLACK, BorderWidth=2):
        if Border:
            pygame.draw.rect(display, BorderColor, (
            self.x - BorderWidth, self.y - BorderWidth, self.w + 2 * BorderWidth, self.h + 2 * BorderWidth))
